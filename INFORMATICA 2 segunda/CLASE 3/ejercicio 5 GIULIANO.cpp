//partiendo del ejercicio 4 ,arme una funcion para mostrar los valores ingresados 
#include <iostream>
#include <stdio.h>
using namespace std;
...
int main(int argc, char *argv[]) {
	...
	free(t);           //ES BUENO PONER free(t=NULL) para decir que el puntero tampoco apuntara a nada ? 
	
	return 0;
}

void mostrar(char *t,int n)
{
	int i=0;
